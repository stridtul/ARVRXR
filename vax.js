...
function vaxInit( rendererOptions = {antialias:true} )
{
	...
	far = 200000;
	if(	perspective )
		camera = new THREE.PerspectiveCamera( 60, 1, 0.1, far );
	else
		camera = new THREE.OrthographicCamera( -window.innerWidth/2, window.innerWidth/2, window.innerHeight/2, -window.innerHeight/2, 1, far );
